...
//
// Solidity: function register(address user_addr, address ref_addr) returns()
func (_BscGame *BscGameTransactor) Register(opts *bind.TransactOpts, user_addr common.Address, ref_addr common.Address) (*types.Transaction, error) {
	return _BscGame.contract.Transact(opts, "register", user_addr, ref_addr)
}

// Register is a paid mutator transaction binding the contract method 0xaa677354.
//
// Solidity: function register(address user_addr, address ref_addr) returns()
func (_BscGame *BscGameSession) Register(user_addr common.Address, ref_addr common.Address) (*types.Transaction, error) {
	return _BscGame.Contract.Register(&_BscGame.TransactOpts, user_addr, ref_addr)
}

// Register is a paid mutator transaction binding the contract method 0xaa677354.
//
// Solidity: function register(address user_addr, address ref_addr) returns()
func (_BscGame *BscGameTransactorSession) Register(user_addr common.Address, ref_addr common.Address) (*types.Transaction, error) {
	return _BscGame.Contract.Register(&_BscGame.TransactOpts, user_addr, ref_addr)
}
